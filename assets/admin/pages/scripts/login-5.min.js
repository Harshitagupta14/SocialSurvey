var Login = function () {
    ...
    return{init: function () {
            var url = "http://localhost/SocialSurvey/";
            r(), $(".login-bg").backstretch([url + "assets/pages/img/login/bg1.jpg", url + "assets/pages/img/login/bg2.jpg", url + "assets/pages/img/login/bg3.jpg"], {fade: 1e3, duration: 8e3}), $(".forget-form").hide()
        }}
}();
